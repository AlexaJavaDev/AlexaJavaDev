...
**4. ООП 🔄 136/850** *(в процессе)*
- 4.1 Классы, объекты, поля — 🔄 45/100
- 4.2 Методы (void, return, параметры и тд.) — 🔄 65/250
- 4.2 Конструкторы (по умолчанию, с параметрами, перегрузка) — 🔄 12/100
- 4.3 Геттеры и сеттеры — 🔄 14/100
