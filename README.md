...
**1. Циклы (базовые) ✅ 102/100**
- for, while, вложенные

**2. Методы строк ✅ 202/200**
...
**4. ООП 🔄 43/600** *(в процессе)*
- 4.1 Классы, объекты, поля, методы (void, return, параметры) — 🔄 30/100
- 4.2 Конструкторы (по умолчанию, с параметрами, перегрузка) — 🔄 5/100
- 4.3 Геттеры и сеттеры — 🔄 8/100
