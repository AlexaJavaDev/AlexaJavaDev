...
**1. Циклы (базовые) ✅ 108/100**
- for, while, вложенные

**2. Методы строк ✅ 213/200**
...
- 4.1 Классы, объекты, поля — 🔄 35/100
- 4.2 Методы (void, return, параметры и тд.) — 🔄 52/250
- 4.2 Конструкторы (по умолчанию, с параметрами, перегрузка) — 🔄 7/100
- 4.3 Геттеры и сеттеры — 🔄 10/100
