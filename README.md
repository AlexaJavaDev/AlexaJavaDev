...
**1. Циклы (базовые) ✅ 113/100**
- for, while, вложенные

**2. Методы строк ✅ 214/200**
...
**4. ООП 🔄 104/850** *(в процессе)*
- 4.1 Классы, объекты, поля — 🔄 40/100
- 4.2 Методы (void, return, параметры и тд.) — 🔄 58/250
- 4.2 Конструкторы (по умолчанию, с параметрами, перегрузка) — 🔄 10/100
- 4.3 Геттеры и сеттеры — 🔄 12/100
